...
NOTES = {
 ...
 7: [('+', '2026년 준공 — 아홉 곳 최신 · 대피소 하타시로초등학교'),
     ('-', '샤워 1개 · 1층에만 있어 3층 네 명이 매일 내려와야 한다')],
 6: [('-', '“새로운 내진 기준을 충족하지 않음” — 호스트 직접 답변'),
     ('-', '건축 연도 “잘 모르겠다” · 제목의 “(신축)”을 믿을 수 없다')],
 ...
 3: [('-', '호스트가 “새로운 내진 기준을 충족하지 않는다”고 직접 답변'),
     ('-', '저지대 · 철제 계단 · 허가번호·대피소는 “알아서 확인하라”')],
...
ORDER = [4, 7, 9, 5, 1, 6, 3, 8, 2]   # 앞 다섯은 순위대로, 뒤 넷은 탈락
...
<div class="ft">
  ...
  <span><b>안전성 5.0 세 곳(4·7·9번) 중 4번이 1순위.</b> 7번이 2분 빠르지만 그건 추정 오차 안이고, 샤워 1개 대 2개는 확정된 차이입니다.</span>
  <span class="r"><b>남은 확인</b> 1번 직원 회신 하나 — 허가번호·건축 연도·내진·대피장소가 전부 미확인
